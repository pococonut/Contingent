...
class PersonalData(Base):
    ...
    personal_id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    ...
    educational_data: Mapped["EducationalData"] = relationship("EducationalData", back_populates="personal_data", uselist=False)
